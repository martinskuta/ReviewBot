...
public class FindReviewerCommand : ReviewCommand
{
    ...
    public FindReviewerCommand(ILoggerFactory loggerFactory, IReviewContextStore contextStore)
        : base(contextStore)
    {
    ...
    {
        return new FindReviewerExecutable(_loggerFactory, this, turnContext, contextStore);
    }

    private class FindReviewerExecutable : ReviewCommandExecutable
    {
        public FindReviewerExecutable(ILoggerFactory loggerFactory, Command command, ITurnContext turnContext, IReviewContextStore contextStore)
