...
public class MakeReviewerBusyCommand : ReviewCommand
{
    ...
    {
        return
            "Way to change status of a reviewer to busy. Busy reviewers are NOT considered when looking for a reviewer, but their debt increases with every review they skip.";
    }
