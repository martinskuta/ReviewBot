...
public class MakeAvailableCommand : ReviewCommand
{
    ...
    public MakeAvailableCommand(ILoggerFactory loggerFactory, IReviewContextStore contextStore)
        : base(contextStore)
    {
    ...
    {
        return new ResumeReviewerExecutable(_loggerFactory, this, turnContext, contextStore);
    }

    private class ResumeReviewerExecutable : ReviewCommandExecutable
    {
        public ResumeReviewerExecutable(ILoggerFactory loggerFactory, Command command, ITurnContext turnContext, IReviewContextStore contextStore)
