...
public class AddReviewCommand : ReviewCommand
{
    ...
    public AddReviewCommand(ILoggerFactory loggerFactory, IReviewContextStore contextStore)
        : base(contextStore)
    {
    ...
    {
        return new AddReviewExecutable(_loggerFactory, this, turnContext, contextStore);
    }

    private class AddReviewExecutable : ReviewCommandExecutable
    {
        public AddReviewExecutable(ILoggerFactory loggerFactory, Command command, ITurnContext turnContext, IReviewContextStore contextStore)
