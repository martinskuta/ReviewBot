...
public class SuspendReviewerCommand : ReviewCommand
{
    ...
    {
        return
            "Way to change status of a reviewer to inactive. Inactive reviewers are NOT considered when looking for a reviewer and their debt does NOT increase. Use it when you are on vacations or when somebody leaves the team for example.";
    }
