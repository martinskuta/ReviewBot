...
public class SuspendReviewerCommand : ReviewCommand
{
    ...
    public SuspendReviewerCommand(ILoggerFactory loggerFactory, IReviewContextStore contextStore)
        : base(contextStore)
    {
    ...
    {
        return new SuspendReviewerExecutable(_loggerFactory, this, turnContext, contextStore);
    }

    private class SuspendReviewerExecutable : ReviewCommandExecutable
    {
        public SuspendReviewerExecutable(ILoggerFactory loggerFactory, Command command, ITurnContext turnContext, IReviewContextStore contextStore)
