...
public class RemoveReviewCommand : ReviewCommand
{
    ...
    public RemoveReviewCommand(ILoggerFactory loggerFactory, IReviewContextStore contextStore)
        : base(contextStore)
    {
    ...
    {
        return new RemoveReviewExecutable(_loggerFactory, this, turnContext, contextStore);
    }

    private class RemoveReviewExecutable : ReviewCommandExecutable
    {
        public RemoveReviewExecutable(ILoggerFactory loggerFactory, Command command, ITurnContext turnContext, IReviewContextStore contextStore)
