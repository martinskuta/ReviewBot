...
public class RegisterReviewerCommand : ReviewCommand
{
    ...
    public RegisterReviewerCommand(ILoggerFactory loggerFactory, IReviewContextStore contextStore)
        : base(contextStore)
    {
    ...
    {
        return new RegisterReviewerExecutable(_loggerFactory, this, turnContext, reviewContextStore);
    }

    private class RegisterReviewerExecutable : ReviewCommandExecutable
    {
        public RegisterReviewerExecutable(ILoggerFactory loggerFactory, Command command, ITurnContext turnContext, IReviewContextStore contextStore)
