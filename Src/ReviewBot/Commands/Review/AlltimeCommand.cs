...
public class AllTimeCommand : ReviewCommand
{
    ...
    public AllTimeCommand(ILoggerFactory loggerFactory, IReviewContextStore contextStore)
        : base(contextStore)
    {
    ...
    {
        return new AllTimeCommandExecutable(_loggerFactory, this, turnContext, contextStore);
    }

    private class AllTimeCommandExecutable : ReviewCommandExecutable
    {
        public AllTimeCommandExecutable(ILoggerFactory loggerFactory, Command command, ITurnContext turnContext, IReviewContextStore contextStore)
