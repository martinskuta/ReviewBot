...
public class ReviewBot : IBot
{
    ...
    public ReviewBot(ILoggerFactory loggerFactory, IReviewContextStore contextStore)
    {
        ...
        _reviewCommands.Add(new RegisterReviewerCommand(loggerFactory, contextStore));
        _reviewCommands.Add(new CurrentStatusCommand(loggerFactory, contextStore));
        _reviewCommands.Add(new AllTimeCommand(loggerFactory, contextStore));
        _reviewCommands.Add(new FindReviewerCommand(loggerFactory, contextStore));
        _reviewCommands.Add(new AddReviewCommand(loggerFactory, contextStore));
        _reviewCommands.Add(new RemoveReviewCommand(loggerFactory, contextStore));
        _reviewCommands.Add(new SuspendReviewerCommand(loggerFactory, contextStore));
        _reviewCommands.Add(new MakeReviewerBusyCommand(loggerFactory, contextStore));
        _reviewCommands.Add(new MakeAvailableCommand(loggerFactory, contextStore));
        _reviewCommands.Add(new CanApprovePullRequestsCommand(loggerFactory, contextStore));
        _reviewCommands.Add(new FixIdCommand(loggerFactory, contextStore));
